        ...
        <section id="contato" className="py-20 bg-slate-900/70">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="text-4xl md:text-5xl font-bold text-white">Pronto para Transformar sua Gestão?</h2>
                    <p className="text-lg text-gray-400 mt-4">Fale com um de nossos especialistas. Sem compromisso.</p>
                </div>
                <div className="max-w-2xl mx-auto bg-slate-800 p-8 rounded-lg border border-slate-700">
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="4" className="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-3 focus:ring-2 focus:ring-brand-gold focus:border-brand-gold outline-none transition" placeholder="Gostaria de agendar uma demonstração..."></textarea>
                        </div>
